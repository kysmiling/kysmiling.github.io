  ...
  */
  ...
  p.mouseReleased = function () {
    if (!splashIsOpen && p.isInBounds()) {
      ...
      currentRawLine = [];
      previousUserPen = userPen;
      document.getElementById('description').innerHTML = "Start drawing " + availableModels[selectModels.selectedIndex];
    }
  }
  ...
  */
  p.draw = function() {
    ...
    if (pen[PEN.END] === 1) {
      ...
      modelIsActive = false;
      document.getElementById('description').innerHTML = "Finished";
    } else {
